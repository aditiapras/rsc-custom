...
export type FormValue = string | number | boolean | Date | File | string[] | undefined
...
export type StepChangeHandler = (currentStep: number, totalSteps: number) => void
...
export type FieldValidationHandler = (fieldName: string, isValid: boolean, error?: string) => void
...
export type FieldValidatorFunction = (field: FieldConfig, value: FormValue) => string | undefined

/** Function untuk format display value */
export type ValueFormatterFunction = (value: FormValue, field: FieldConfig) => string